      ...
      requiredSoftware: [
        {
          ...
          description: "Configura tu IDE para usar las librerías MPI, OpenMP y Pthreads.",
        },
        {
          name: "Git",
          url: "https://git-scm.com",
          setupGuide: "",
          description: "Instala tu sistema de control de versiones.",
        },
        {
          name: "CUDA Toolkit",
          url: "https://developer.nvidia.com/cuda-toolkit",
          setupGuide: "",
          description: "Instala el compilador de CUDA.",
        },
      ],
      extensions: [
        {
