...
<CodeBlock language="c" content={`#define TAG_MENSAJE1 1
...
<CodeBlock language="c" content={`// Cada proceso calcula su rango de trabajo
...
**Corrección usando comunicación no bloqueante:**

<CodeBlock language="c" content={`// Problemático (bloqueante)
...
**Compilación (si se usa pausa_personalizada):**

<CodeBlock language="bash" content={`# Compilar pausa_personalizada.c primero
...
<CodeBlock language="c" content={`// Reducción usando árbol binario
int step = 1;
...
**Operaciones colectivas sugeridas:**

<CodeBlock language="c" content={`// Paso 2: Broadcast del número inicial
...
<CodeBlock language="c" content={`// Fórmula general
