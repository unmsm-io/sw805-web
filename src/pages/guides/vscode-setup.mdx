  ...
  steps={[
    {
      ...
      content: "Visita la [página oficial de Visual Studio Code](https://code.visualstudio.com) y descarga la versión correspondiente a tu sistema operativo. VSCode está disponible para Windows, macOS y varias distribuciones de Linux."
    },
    {
      title: "Instalar VSCode",
      content: "Ejecuta el instalador y sigue las instrucciones en pantalla. En Windows, asegúrate de marcar la opción 'Add to PATH' durante la instalación para poder abrir VSCode desde la terminal."
    },
    {
      title: "Verificar la instalación",
      content: "Abre VSCode y asegúrate de que se inicia correctamente. Familiarízate con la interfaz: el explorador de archivos a la izquierda, el editor en el centro y la terminal integrada que puedes abrir con `Ctrl+` (o `Cmd+` en macOS)."
    }
  ]}
/>
